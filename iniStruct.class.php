 ...
 *   'debug.enabled' => 1
 *
 * This class allows you to convert the specified ini file into a
 * multi-dimensional
 ...
 *       'enabled' => 1
 *
 * As you can also see you can have sections that extend other sections (use ":"
 * for that).
 * The extendable section must be defined BEFORE the extending section or
 * otherwise
...
class INIStruct
{
     ...
     * @param boolean $process_sections By setting the process_sections parameter
     * to TRUE,
     *                                  you get a multidimensional array, with
     * the section
     *                                  names and settings included. The default
     * for
